...
function EditTask({ EditTaskId, setEditTaskDiv }) {
    ...
    <div className="bg-white rounded px-4 py-4 w-[40%]">
      ...
      <form className="flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between gap-4">
          <button
            type="submit"
            className="w-full bg-blue-800 text-white py-2 hover:bg-blue-700 transition-all duration-300 rounded"
            onClick={(event) => {
              editTask(event, Values._id);
            }}
          >
            Edit Task
          </button>
